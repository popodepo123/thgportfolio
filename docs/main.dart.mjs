...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1282: () => globalThis.window.navigator.userAgent,
      ...
      _1353: Object.is,
      _1357: (o, c) => o instanceof c,
      _1358: o => Object.keys(o),
      _1388: x0 => new Array(x0),
      _1390: x0 => x0.length,
      _1392: (x0,x1) => x0[x1],
      _1393: (x0,x1,x2) => { x0[x1] = x2 },
      _1396: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1398: x0 => new Int8Array(x0),
      _1399: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1401: x0 => new Uint8ClampedArray(x0),
      _1403: x0 => new Int16Array(x0),
      _1405: x0 => new Uint16Array(x0),
      _1407: x0 => new Int32Array(x0),
      _1409: x0 => new Uint32Array(x0),
      _1411: x0 => new Float32Array(x0),
      _1413: x0 => new Float64Array(x0),
      _1437: x0 => x0.random(),
      _1440: () => globalThis.Math,
      _1453: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1454: (handle) => clearTimeout(handle),
      _1455: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1456: (handle) => clearInterval(handle),
      _1457: (c) =>
      ...
      _1492: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1492(f,arguments.length,x0,x1) }),
      _1493: o => {
      ...
      _1520: (o, p) => o[p],
      _1521: (o, p, v) => o[p] = v,
      _1537: () => new AbortController(),
      _1538: x0 => x0.abort(),
      _1539: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1540: (x0,x1) => globalThis.fetch(x0,x1),
      _1541: (x0,x1) => x0.get(x1),
      _1542: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1542(f,arguments.length,x0,x1,x2) }),
      _1543: (x0,x1) => x0.forEach(x1),
      _1544: x0 => x0.getReader(),
      _1545: x0 => x0.cancel(),
      _1546: x0 => x0.read(),
      _1547: o => o instanceof Array,
      _1552: a => a.pop(),
      _1553: (a, i) => a.splice(i, 1),
      _1555: (a, s, e) => a.slice(s, e),
      _1557: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1558: a => a.length,
      _1560: (a, i) => a[i],
      _1561: (a, i, v) => a[i] = v,
      _1563: o => {
      ...
      _1564: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1566: o => o instanceof Uint8Array,
      _1567: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1568: o => o instanceof Int8Array,
      _1569: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1570: o => o instanceof Uint8ClampedArray,
      _1571: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1572: o => o instanceof Uint16Array,
      _1573: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1574: o => o instanceof Int16Array,
      _1575: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1576: o => o instanceof Uint32Array,
      _1577: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1578: o => o instanceof Int32Array,
      _1579: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1581: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1582: o => o instanceof Float32Array,
      _1583: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1584: o => o instanceof Float64Array,
      _1585: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1586: (t, s) => t.set(s),
      _1588: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1590: o => o.buffer,
      _1591: o => o.byteOffset,
      _1592: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1593: (b, o) => new DataView(b, o),
      _1594: (b, o, l) => new DataView(b, o, l),
      _1595: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1596: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1597: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1598: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1599: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1600: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1601: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1602: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1603: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1604: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1605: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1606: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1609: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1610: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1611: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1612: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1613: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1614: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1615: Function.prototype.call.bind(Number.prototype.toString),
      _1616: Function.prototype.call.bind(BigInt.prototype.toString),
      _1617: Function.prototype.call.bind(Number.prototype.toString),
      _1618: (d, digits) => d.toFixed(digits),
      _1634: () => globalThis.document,
      _1635: () => globalThis.window,
      _1640: (x0,x1) => { x0.height = x1 },
      _1642: (x0,x1) => { x0.width = x1 },
      _1644: (x0,x1) => { x0.pointerEvents = x1 },
      _1647: x0 => x0.head,
      _1648: x0 => x0.classList,
      _1652: (x0,x1) => { x0.innerText = x1 },
      _1653: x0 => x0.style,
      _1655: x0 => x0.sheet,
      _1656: x0 => x0.src,
      _1657: (x0,x1) => { x0.src = x1 },
      _1658: x0 => x0.naturalWidth,
      _1659: x0 => x0.naturalHeight,
      _1666: x0 => x0.offsetX,
      _1667: x0 => x0.offsetY,
      _1668: x0 => x0.button,
      _1675: x0 => x0.status,
      ...
      _2297: (x0,x1) => { x0.referrerPolicy = x1 },
      _2299: (x0,x1) => { x0.loading = x1 },
      _3511: () => globalThis.window,
      _3573: x0 => x0.navigator,
      _3962: x0 => x0.userAgent,
      _6077: x0 => x0.target,
      _6117: x0 => x0.signal,
      _6191: () => globalThis.document,
      _6605: x0 => x0.tagName,
      _7042: x0 => x0.ctrlKey,
      _7043: x0 => x0.shiftKey,
      _7044: x0 => x0.altKey,
      _7045: x0 => x0.metaKey,
      _7953: x0 => x0.value,
      _7955: x0 => x0.done,
      _8657: x0 => x0.url,
      _8659: x0 => x0.status,
      _8661: x0 => x0.statusText,
      _8662: x0 => x0.headers,
      _8663: x0 => x0.body,
      _10791: (x0,x1) => { x0.border = x1 },
      _11059: (x0,x1) => { x0.cursor = x1 },
      _11069: (x0,x1) => { x0.display = x1 },
      _11233: (x0,x1) => { x0.height = x1 },
      _11445: (x0,x1) => { x0.opacity = x1 },
      _11923: (x0,x1) => { x0.width = x1 },
      _12291: x0 => x0.name,
